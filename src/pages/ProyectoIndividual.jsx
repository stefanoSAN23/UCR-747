...
export default function ProyectoIndividual() {
  ...
  const handleEdit = () => {
    setPhotoType(proyecto.photo_project?.startsWith("data:") ? "file" : "url");
    setPhotoPreview(proyecto.photo_project || null);
    setFormData({
      creator_id: proyecto.creator_id,
      category_id: proyecto.category_id,
      name_project: proyecto.name_project,
      description: proyecto.description || "",
      photo_project: proyecto.photo_project || "",
      date: proyecto.date || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await projectsAPI.update(proyecto.project_id, submitData);
      setShowModal(false);
      fetchProyecto();
    } catch (err) {
